...
// checks if the CreateDraftRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDraftRequest{}

// CreateDraftRequest struct for CreateDraftRequest
...
func (o CreateDraftRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateDraftRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDraftRequest struct {
	value *CreateDraftRequest
	isSet bool
}

func (v NullableCreateDraftRequest) Get() *CreateDraftRequest {
	return v.value
}

func (v *NullableCreateDraftRequest) Set(val *CreateDraftRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDraftRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDraftRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDraftRequest(val *CreateDraftRequest) *NullableCreateDraftRequest {
	return &NullableCreateDraftRequest{value: val, isSet: true}
}

func (v NullableCreateDraftRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDraftRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
