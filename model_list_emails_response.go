...
type _ListEmailsResponse ListEmailsResponse
...
func (o *ListEmailsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListEmailsResponse := _ListEmailsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListEmailsResponse)

	if err != nil {
		return err
	}

	*o = ListEmailsResponse(varListEmailsResponse)
