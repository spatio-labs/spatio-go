...
**TokenType** | **string** |  | 
**ExpiresIn** | **int32** | Seconds until access_token expires. | 
**RefreshToken** | Pointer to **string** |  | [optional] 
**Scope** | Pointer to **string** |  | [optional] 
**IdToken** | Pointer to **string** | Only present when &#x60;openid&#x60; scope was granted. RS256-signed JWT — verify against the JWKS. | [optional] 
